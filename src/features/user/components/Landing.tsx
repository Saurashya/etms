  ...
  return (
    <div className="w-full h-[70vh] md:h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full gap-6 px-4 md:px-10">
        ...
        {/* Search Section */}
        <div className="w-full max-w-[1360px] min-h-[316px] bg-[linear-gradient(to_right,_#1EBBD7FF_0%,_#1EBBD7FF_50%,_#1EBBD766_100%)] rounded-md p-4 md:p-6 flex flex-col gap-8">
          ...
          <div className="text-white mb-4">
            ...
            <p className="text-sm md:text-lg">
              Discover concerts, festivals, conferences, workshops and more near
              you.
            </p>
          </div>

          {/* Input Section */}
          <div className="flex flex-col md:flex-row flex-wrap justify-between items-center gap-4 bg-[rgba(40,90,99,0.25)] p-4 rounded-md">
            
            {/* Search Bar */}
            <div className="flex items-center border-b-2 border-white w-full sm:w-[320px] md:w-[400px] lg:w-[480px]">
              <input
                type="text"
            ...
            {/* City Dropdown */}
            <div className="flex items-center gap-2 text-white text-base w-full md:w-auto">
              <PiCityFill
                size={28}
